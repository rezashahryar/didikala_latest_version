...
class SubProductCategory(models.Model):
    main_category = models.ForeignKey(ProductCategory, on_delete=models.CASCADE, related_name='children', null=True, blank=True, verbose_name=_('دسته بندی اصلی'))
    parent = models.ForeignKey('self', related_name='sub_children', on_delete=models.CASCADE, null=True, blank=True, verbose_name=_('والد'))
    title = models.CharField(_('عنوان'), max_length=100)
...
class Product(models.Model):
    ...
    img_one = models.ImageField(_('عکس اول'), upload_to='products/img_one', null=True, blank=True)
    img_two = models.ImageField(_('عکس دوم'), upload_to='products/img_two', null=True, blank=True)
    img_three = models.ImageField(_('عکس سوم'), upload_to='products/img_three', null=True, blank=True)
